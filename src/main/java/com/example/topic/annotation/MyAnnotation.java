 ...
 *
 * @Override，@Deprecated，@SuppressWarnings为常见的3个注解。 注解相当于一种标记，在程序中加上了注解就等于为程序加上了某种标记，以后，
 * <p>
 ...
 * {
 * @MyTarget public void doSomething()
 * {
 ...
 * @Deprecated
 * @SuppressWarnings("") public void output()
 * {
 ...
 * }
 * 可以这样用：
 * @MyTarget("aaa") public void doSomething()
 * {
 * System.out.println("hello world");
 * }
 * <p>
